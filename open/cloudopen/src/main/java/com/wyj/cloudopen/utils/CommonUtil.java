...
import com.wyj.cloudopen.utils.constants.Constants;
import com.wyj.cloudopen.utils.constants.ErrorEnum;
...
public class CommonUtil {
     ...
     * @return
     */
    public static JSONObject successJson(String returnString) {
        JSONObject resultJson = new JSONObject();
        resultJson.put("code", returnString);
        return resultJson;
    }
